---
title: Contributing
description: How to contribute to the Minions OpenClaw project.
---
...
2. Clone your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/minions-openclaw.git
   ```
...
|-----------|-------------|
| `packages/core/` | TypeScript SDK (`@minions-openclaw/sdk` on npm) |
| `packages/python/` | Python SDK (`minions-openclaw` on PyPI) |
| `packages/cli/` | CLI tool (`@minions-openclaw/cli`) |
