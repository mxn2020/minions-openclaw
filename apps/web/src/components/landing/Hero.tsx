            ...
            <div className="container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-muted max-w-2xl">
                        Register, monitor, snapshot, and configure your OpenClaw Gateway instances from one place.
                        Every state change is versioned, diffable, and queryable.
                    </p>
                    ...
                    <div className="font-mono text-sm text-muted mt-4">
                        ...
                        <span> install -g @minions-openclaw/cli</span>
                    </div>
                </motion.div>
            </div>
        </section>
