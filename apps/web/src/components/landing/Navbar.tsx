        ...
        <nav className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-md">
            <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
                ...
                <div className="hidden md:flex items-center space-x-6">
                    <a href="https://github.com/mxn2020/minions-openclaw" target="_blank" rel="noreferrer" className="text-sm font-medium text-muted transition-colors hover:text-primary">Docs</a>
                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <div className="flex flex-col space-y-4 p-4">
                            <a href="https://github.com/mxn2020/minions-openclaw" target="_blank" rel="noreferrer" className="text-sm font-medium text-muted hover:text-primary">Docs</a>
