                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted">
                            ...
                            <li><a href="https://github.com/mxn2020/minions-openclaw" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">GitHub</a></li>
                            <li><a href="https://www.npmjs.com/package/@minions-openclaw/cli" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">NPM</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-sm font-semibold text-primary mb-4">Legal</h3>
                        <ul className="space-y-2 text-sm text-muted">
                            <li><a href="https://github.com/mxn2020/minions-openclaw/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">License (MIT)</a></li>
                        </ul>
                    </div>
                </div>
